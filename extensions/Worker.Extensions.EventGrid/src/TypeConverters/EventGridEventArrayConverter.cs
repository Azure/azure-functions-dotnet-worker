...
namespace Microsoft.Azure.Functions.Worker.Extensions.EventGrid.TypeConverters
{
    ...
    internal class EventGridEventArrayConverter : EventGridConverterBase<EventGridEvent[]>
    {
        public EventGridEventArrayConverter(ILogger<EventGridEventArrayConverter> logger)
            : base(logger)
        {
        }
