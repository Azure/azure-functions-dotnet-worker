...
namespace Microsoft.Azure.Functions.Worker
{
    ...
    {
        public QueueMessageJsonElementConverter(ILogger<QueueMessageJsonElementConverter> logger) : base(logger)
        {
        }
        ...
        public override async ValueTask<ConversionResult> ConvertAsync(ConverterContext context)
        {
            ...
            try
            {
                ...
                var result = JsonDocument.Parse(messageText).RootElement;
