...
internal partial class FunctionExecutorGenerator
{
    ...
    {
        public static string Emit(IEnumerable<ExecutableFunction> functions, CancellationToken cancellationToken)
        {
            string result = $$"""
                         // <auto-generated/>
                         using System;
        ...
        private static string GetMethodsContent(IEnumerable<ExecutableFunction> functions)
        {
