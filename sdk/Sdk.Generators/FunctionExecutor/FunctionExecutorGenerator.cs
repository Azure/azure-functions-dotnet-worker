...
namespace Microsoft.Azure.Functions.Worker.Sdk.Generators
{
    ...
    public sealed partial class FunctionExecutorGenerator : ISourceGenerator
    {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            // We emit even when there are zero functions so that the generated IFunctionExecutor is always
            // registered, keeping the worker on the generated execution path regardless of function count.
