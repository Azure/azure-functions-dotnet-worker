...
namespace Microsoft.Azure.Functions.Worker.Sdk.Generators
{
    ...
    public partial class FunctionMetadataProviderGenerator : ISourceGenerator
    {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            // requires a functions.metadata file that the new SDK does not produce. Validation errors
            // (duplicates, invalid bindings, etc.) still produce error diagnostics, which fail the
            // build by default.
