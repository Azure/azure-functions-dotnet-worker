...
internal static class ReflectionExtensions
{
    extension(MetadataReader reader)
    {
        ...
        public bool AttributeInheritsFrom(CustomAttribute attribute, string targetFullName, StringComparison comparison)
        {
            Throw.IfNull(reader);
    ...
    extension(CustomAttribute attribute)
    {
        ...
        public CustomAttributeValue<string> DecodeArguments()
        {
