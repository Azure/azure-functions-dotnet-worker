...
namespace Microsoft.Azure.Functions.Worker.Logging.ApplicationInsights
{
    internal class WebJobsTelemetryInitializer : ITelemetryInitializer
    {
        ...
        public void Initialize(ITelemetry telemetry)
        {
            ...
            IDictionary<string, string> telemetryProps = telemetryContext.GlobalProperties;
        ...
        private static bool TryApplyProperty(RequestTelemetry request, KeyValuePair<string, string?> activityTag)
        {
