...
namespace Microsoft.Azure.Functions.Worker.Tests.OpenTelemetry;

public class EndToEndTests
{
    private IFunctionsApplication _application;
    private IInvocationFeaturesFactory _invocationFeaturesFactory;
    private readonly FunctionDefinition _funcDefinition = new();
    ...
    {   
        ...
        var activity = FunctionDefinition.LastActivity;
    ...
    internal class FunctionDefinition : Worker.FunctionDefinition
    {
        public static readonly string DefaultPathToAssembly = typeof(FunctionDefinition).Assembly.Location;
        public static readonly string DefaultEntryPoint = $"{typeof(FunctionDefinition).FullName}.{nameof(TestFunction)}";
