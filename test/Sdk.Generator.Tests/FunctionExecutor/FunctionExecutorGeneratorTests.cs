...
{GetExpectedExtensionMethodCode(includeAutogenAttributes: includeAutogeneratedAttributeDecoration)}
        ...
        {
            var generatedClassAttrName = nameof(AutoGeneratedClassAttribute).TrimStringFromEnd("Attribute");
            var generatedMethodAttrName = nameof(AutoGeneratedHostBuilderConfigureMethodAttribute).TrimStringFromEnd("Attribute");
