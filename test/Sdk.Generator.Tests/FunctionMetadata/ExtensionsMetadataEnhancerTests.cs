...
namespace Microsoft.Azure.Functions.Sdk.Generator.FunctionMetadata.Tests
{
    public class ExtensionsMetadataEnhancerTests
    {
        ...
        {
            string assembly = Path.Combine(TestUtility.RepoRoot, "out", "bin", "src", "FunctionMetadataLoader", TestUtility.Config, "Microsoft.Azure.WebJobs.Extensions.FunctionMetadataLoader.dll");
