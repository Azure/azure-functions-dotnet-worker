...
namespace Microsoft.Azure.Functions.Sdk.Generator.FunctionMetadataProvider.Tests
{
    public partial class FunctionMetadataProviderGeneratorTests
    {
        public class ServiceBusTests
        {
            ...
            [InlineData(LanguageVersion.CSharp7_3)]
            [InlineData(LanguageVersion.Latest)]
            public async Task ServiceBusOutputByteArrayReturn(LanguageVersion languageVersion)
            {
                string inputCode = """
                using System;
                using System.Threading.Tasks;
                ...
                namespace SampleApp
                {
                    public static class ServiceBusOutputFunction
                    {
                        [Function("ServiceBusByteArrayOutputFunction")]
                        [ServiceBusOutput("queue", Connection = "ServiceBusConnection")]
                        public static byte[] Run(
                            [ServiceBusTrigger("inputQueue", Connection = "ServiceBusConnection")] ServiceBusReceivedMessage message)
                        {
                            throw new NotImplementedException();
                        }
                    }
                ...
                namespace TestProject
                {
                    ...
                    public class GeneratedFunctionMetadataProvider : IFunctionMetadataProvider
                    {
                        ...
                        public Task<ImmutableArray<IFunctionMetadata>> GetFunctionMetadataAsync(string directory)
                        {
                            var metadataList = new List<IFunctionMetadata>();
                            var Function0RawBindings = new List<string>();
                            Function0RawBindings.Add(@"{""name"":""$return"",""type"":""serviceBus"",""direction"":""Out"",""queueOrTopicName"":""queue"",""entityType"":""Queue"",""connection"":""ServiceBusConnection"",""dataType"":""Binary""}");
                            Function0RawBindings.Add(@"{""name"":""message"",""type"":""serviceBusTrigger"",""direction"":""In"",""properties"":{""supportsDeferredBinding"":""True""},""queueName"":""inputQueue"",""connection"":""ServiceBusConnection"",""cardinality"":""One""}");

                            var Function0 = new DefaultFunctionMetadata
                            {
                                Language = "dotnet-isolated",
                                Name = "ServiceBusByteArrayOutputFunction",
                                EntryPoint = "SampleApp.ServiceBusOutputFunction.Run",
                                RawBindings = Function0RawBindings,
                                ScriptFile = "TestProject.dll"
                            };
                            metadataList.Add(Function0);
