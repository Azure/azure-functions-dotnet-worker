...
namespace Microsoft.Azure.Functions.SdkGeneratorTests
{
    ...
    {
        public class AutoRegistrationAttributesTests
        {
            private readonly Assembly[] _referencedExtensionAssemblies;

            public AutoRegistrationAttributesTests()
            {
...
{GetExpectedExtensionMethodCode(includeAutogeneratedAttributes: includeAutogeneratedAttributeDecoration)}
}}";
                var buildPropertiesDict = new Dictionary<string, string>()
                {
                    {  Constants.BuildProperties.AutoRegisterGeneratedMetadataProvider, includeAutogeneratedAttributeDecoration.ToString()}
                };
        ...
        private static string GetExpectedExtensionMethodCode(bool includeAutogeneratedAttributes = false)
        {
            if (includeAutogeneratedAttributes)
            {
                return """
