...
namespace Microsoft.Azure.Functions.WorkerExtension.Tests.Blob
{
    public class BlobStorageConverterCoreTests
    {
        ...
        {
            // Arrange
            var grpcModelBindingData = Helper.GetTestGrpcModelBindingData(BlobTestHelper.GetTestBinaryData(), "anotherExtensions");
            var context = new TestConverterContext(typeof(BlobClient), grpcModelBindingData);
        ...
        {
            // Arrange
            var grpcModelBindingData = Helper.GetTestGrpcModelBindingData(BlobTestHelper.GetTestBinaryData(), "AzureStorageBlobs", contentType: "binary");
            var context = new TestConverterContext(typeof(BlobClient), grpcModelBindingData);
        ...
        {
            // Arrange
            var grpcModelBindingData = Helper.GetTestGrpcModelBindingData(BlobTestHelper.GetTestBinaryData(null), "AzureStorageBlobs");
            var context = new TestConverterContext(typeof(BlobClient), grpcModelBindingData);
        ...
        {
            // Arrange
            var grpcModelBindingData = Helper.GetTestGrpcModelBindingData(BlobTestHelper.GetTestBinaryData(container: null), "AzureStorageBlobs");
            var context = new TestConverterContext(typeof(BlobClient), grpcModelBindingData);
