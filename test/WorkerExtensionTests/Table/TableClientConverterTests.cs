...
namespace Microsoft.Azure.Functions.WorkerExtension.Tests.Table
{
    public class TableClientConverterTests
    {
        ...
        {
            object source = TableTestHelper.GetTestGrpcModelBindingData(TableTestHelper.GetWrongBinaryData());
            var result = new Mock<TableClient>();
            var context = new TestConverterContext(typeof(TableClient), source);
        ...
        {
            var grpcModelBindingData = TableTestHelper.GetTestGrpcModelBindingData(TableTestHelper.GetTableClientBinaryData(), source: "anotherExtensions");
        ...
        {
            var grpcModelBindingData = TableTestHelper.GetTestGrpcModelBindingData(TableTestHelper.GetTableClientBinaryData(), contentType: "binary");
            var context = new TestConverterContext(typeof(TableClient), grpcModelBindingData);
