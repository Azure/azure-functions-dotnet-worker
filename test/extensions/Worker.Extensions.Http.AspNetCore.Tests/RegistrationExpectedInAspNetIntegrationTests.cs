    ...
    public class RegistrationExpectedInAspNetIntegrationTests
    {
        ...
        public async Task CodeFixerWorks()
        {
            ...
            var expectedDiagnosticResult = CodeFixVerifier
                                            ...
                                            .WithArguments(ExpectedRegistrationMethod); // 11th line, 34th character(Run method)
